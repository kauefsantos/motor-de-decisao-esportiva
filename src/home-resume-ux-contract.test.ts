...
describe("home resume UX", () => {
  it("renders resume navigation as real buttons instead of nesting a custom component inside Button asChild", () => {
  ...
  it("makes pending registrations directly actionable from the Now summary", () => {
    const home = source("./routes/index.tsx");
