...
-- positive stake, and unavailable CLV captures receive a bounded retry budget.
...
as $$
  ...
  where r.owner_id=p_owner_id
    ...
    and t.clv_status='SOURCE_UNAVAILABLE'
...
values(
  ...
  'Positive stake now requires a production-validated calibrated prediction at the database boundary. CLV unavailable captures receive a bounded three-attempt retry budget exposed through an owner-scoped service RPC.'
)
